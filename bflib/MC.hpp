...
class MC
{
    ...
    public:
        ...
        MC(int N, State minState, State maxState) : NMax(N), minState(minState), maxState(maxState)
        {
            Q.setIdentity();
            R.setIdentity();
            x.setZero();
        ...
        MC(int N, State X, State minState, State maxState) : x(X), NMax(N), minState(minState), maxState(maxState)
        {
            Q.setIdentity();
            R.setIdentity();
            init();
        ...
        MC(int N, State minState, State maxState, ResampleStd Q, SensorStd R) : Q(Q), R(R), NMax(N), minState(minState), maxState(maxState)
        {
            x.setZero();
            init();
        }

        MC(int N, State X, State minState, State maxState, ResampleStd Q, SensorStd R) : x(X), Q(Q), R(R), NMax(N), minState(minState), maxState(maxState)
        {
            init();
        }
